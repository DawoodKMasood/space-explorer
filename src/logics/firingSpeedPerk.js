class FiringSpeedPerk extends Phaser.Physics.Arcade.Sprite {
    ...
    // For example, increase the firing speed for the player
    collect() {
        // Implement the logic for collecting the perk item here
        // For example, increase the player's firing speed
        this.playerShip.bonusFiringSpeed += 1; // You can adjust the value as needed
